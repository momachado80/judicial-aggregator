            ...
            for tipo in request.tipos_processo:
                ...
                for hit in hits:
                    ...
                    processo = {
                        ...
                        "url_tjsp": f"https://esaj.tjsp.jus.br/cpopg/search.do?conversationId=&cbPesquisa=NUMPROC&numeroDigitoAnoUnificado=&foroNumeroUnificado=&dadosConsulta.valorConsultaNuUnificado={numero_formatado}" if tribunal == "TJSP" else None
                    }
